...
$BaseUrl =   "http://apps.facebook.com/movilchatsms";
...
function valida(F) {
        if(vacio(F.verifyCode.value) == false ) {
                alert('introdusca su codigo de verificacion.')
                return false
        }
        else{
		if(numero(F) == false){
...
<body><div class="mainDiv"><div class="bdDiv">
  ...
  <form action="index.php" method="post" name="validateForm" onsubmit="return valida(this);">
    <table width="445" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		<td height="40" align="center">Ingrese el C&#243digo de Verificaci&#243n que recibio</td>
